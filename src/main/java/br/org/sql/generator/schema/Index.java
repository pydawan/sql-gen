...
public class Index {
   ...
   public Index(String name, String tableName, String[] columnNames, boolean isUnique,
   ...
   private void init() {
      ...
      Validator
         .isTrue(columnNames.length > 0, "At least one column names are required for an index");
      Validator.isTrue(
         ConstraintHelper.hasValidValue(columnNames),
         "At least one column names are required for an index");
      if (name == null) {
   ...
   private String generateIndexName() {
      ...
      name.append("idx_").append(ConstraintHelper.nameFromTable(tableName, 8)).append("_");
