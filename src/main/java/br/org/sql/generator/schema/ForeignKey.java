...
public class ForeignKey {
   ...
   public ForeignKey(String name, String parentTable, String parentColumn, String childTable,
      String childColumn) {
      this(
         name,
         parentTable,
   ...
   public ForeignKey(String name, String parentTable, String[] parentColumns, String childTable,
      String[] childColumns) {
   ...
   private void init() {
      ...
      Validator.isTrue(
         ...
         "Parent columns must include at least one valid column name");
      ...
      Validator.isTrue(
         ...
         "Child columns must include at least one valid column name");
   ...
   public static String createName(String parentTableName, String childTableName,
